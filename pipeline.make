...
programs: nanopolish minimap2 samtools
...
BASECALL=/.mounts/labs/simpsonlab/envs/albacore/albacore-2.3.3-venv/bin/read_fast5_basecaller.py
...
prep_10x:
	...
	$(SAMTOOLS) view $(10X.SAM) -o $(10X.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 10xpolya.sorted.bam 10xpolya.bam && $(SAMTOOLS) index 10xpolya.sorted.bam
	cd $(10X.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(10X.FAST5) --sequencing_summary=$(10X.SEQSUMMARY) 10xpolyA.fastq
	cd $(BASEDIR)
...
prep_15x:
	...
	$(SAMTOOLS) view $(15X.SAM) -o $(15X.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 15xpolya.sorted.bam 15xpolya.bam && $(SAMTOOLS) index 15xpolya.sorted.bam
	cd $(15X.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(15X.FAST5) --sequencing_summary=$(15X.SEQSUMMARY) 15xpolyA.fastq
	cd $(BASEDIR)
...
prep_30x:
	...
	$(SAMTOOLS) view $(30X.SAM) -o $(30X.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 30xpolya.sorted.bam 30xpolya.bam && $(SAMTOOLS) index 30xpolya.sorted.bam
	cd $(30X.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(30X.FAST5) --sequencing_summary=$(30X.SEQSUMMARY) 30xpolyA.fastq
	cd $(BASEDIR)
...
prep_60xb:
	...
	$(SAMTOOLS) view $(60XB.SAM) -o $(60XB.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 60xBpolya.sorted.bam 60xBpolya.bam && $(SAMTOOLS) index 60xBpolya.sorted.bam
	cd $(60XB.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(60XB.FAST5) --sequencing_summary=$(60XB.SEQSUMMARY) 60xBpolyA.fastq
	cd $(BASEDIR)
...
prep_60xn:
	...
	$(SAMTOOLS) view $(60XN.SAM) -o $(60XN.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 60xNpolya.sorted.bam 60xNpolya.bam && $(SAMTOOLS) index 60xNpolya.sorted.bam
	cd $(60XN.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(60XN.FAST5) --sequencing_summary=$(60XN.SEQSUMMARY) 60xNpolyA.fastq
	cd $(BASEDIR)
...
prep_60x:
	...
	$(SAMTOOLS) view $(60X.SAM) -o $(60X.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 60xpolya.sorted.bam 60xpolya.bam && $(SAMTOOLS) index 60xpolya.sorted.bam
	cd $(60X.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(60X.FAST5) --sequencing_summary=$(60X.SEQSUMMARY) 60xpolyA.fastq
	cd $(BASEDIR)
...
prep_80x:
	...
	$(SAMTOOLS) view $(80X.SAM) -o $(80X.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 80xpolya.sorted.bam 80xpolya.bam && $(SAMTOOLS) index 80xpolya.sorted.bam
	cd $(80X.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(80X.FAST5) --sequencing_summary=$(80X.SEQSUMMARY) 80xpolyA.fastq
	cd $(BASEDIR)
...
prep_100x:
	...
	$(SAMTOOLS) view $(100X.SAM) -o $(100X.BAM)
	cd $(ALIGNDIR) && $(SAMTOOLS) sort -o 100xpolya.sorted.bam 100xpolya.bam && $(SAMTOOLS) index 100xpolya.sorted.bam
	cd $(100X.FASTQ.DIR) && $(NANOPOLISH) index --directory=$(100X.FAST5) --sequencing_summary=$(100X.SEQSUMMARY) 100xpolyA.fastq
	cd $(BASEDIR)
...
polya: 10x.polya.tsv 15x.polya.tsv 30x.polya.tsv 60xB.polya.tsv 60xN.polya.tsv 60x.polya.tsv 80x.polya.tsv 100x.polya.tsv
...
plot_segmentations: ont10x.seg.png ont15x.seg.png ont30x.seg.png ont60xB.seg.png ont60xN.seg.png \
		    ont60x.seg.png ont80x.seg.png ont100x.seg.png
